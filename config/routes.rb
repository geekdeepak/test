ActionController::Routing::Routes.draw do |map|
  ...
  tasks_collection = { :tomorrow => :get, :today => :get, :overdue => :get, :completed => :get, :undated => :get,:paused=>:get ,:opened=>:get,:order => :get}
  
  map.resources :tasks, :collection => tasks_collection, :member => { :start => :get,:logs => :get, :complete => :put, :pause => :put ,:sync_log => :get}
